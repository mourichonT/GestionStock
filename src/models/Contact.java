...
public class Contact {
	...
	public Contact (int contId, String contName, String contFName, String contPhone, String contCell,
			String contMail, String contPosition, String contComment) {
		this.contId = contId;
	...
	public String toString() {
		...
		string.append("contact [contId=").append(contId)
		.append(", contName=").append(contName)
		.append(", contFName=").append(contFName)
		.append(", contPhone=").append(contPhone)
		.append(", contCell=").append(contCell)
		.append(", contMail=").append(contMail)
		.append(", contPosition=").append(contPosition)
		.append(", contComment=").append(contComment)
