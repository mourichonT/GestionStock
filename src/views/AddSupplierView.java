		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean saveOk = false;	
					...
					try {
						Contact contact = new Contact(0, txtNameCont.getText(), txtFName.getText(),txtPhoneCont.getText(),txtCell.getText(), txtMail.getText(), txtPosition.getText(), contComment);
						contactId = addContact.addNewContact(contact);
						Supplier supplier = new Supplier(0, textAddress.getText(),txtName.getText(), txtPhone.getText(), contactId);

						JOptionPane.showMessageDialog(null, "enregistré");
						saveOk = addSup.addNewSupplier(supplier);
