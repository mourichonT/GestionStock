...
public class StockView extends JInternalFrame {
	...
	public StockView() throws SQLException, PropertyVetoException {
		...
		String[] header = { "Id", "Nom Produit", "Specificités", "Fournisseur", "Date d'ajout", "Prix HT", "Quantité",
				"Type" };
				...
				if (flag) {
					...
					try {
						int reply = JOptionPane.showConfirmDialog(null,
								"êtes-vous sur de vouloir supprimer cet article", TITLE_PROPERTY,
		...
		btnModify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Article article = new Article(id, name, spec, supName, price, quantity, comment, TypId, userId);
